...
## Environments
- Preview: https://main--aem-eds-forms-boilerplate--aditiagarwal28.aem.page/
- Live: https://main--aem-eds-forms-boilerplate--aditiagarwal28.aem.live/
...
1. Open the `aem-eds-forms-boilerplate` directory in your favorite IDE and start coding :)
